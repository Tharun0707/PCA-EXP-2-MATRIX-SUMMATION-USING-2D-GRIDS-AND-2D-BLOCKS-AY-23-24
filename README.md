...
## OUTPUT:
<img width="1142" height="284" alt="image" src="https://github.com/user-attachments/assets/151f5282-6da7-459f-9a5b-ae9e810a3d48" />


## RESULT:
The host took 0.885181 seconds to complete it’s computation, while the GPU outperforms the host and completes the computation in 0.05995 seconds. Therefore, float variables in the GPU will result in the best possible result. Thus, matrix summation using 2D grids and 2D blocks has been performed successfully.
